...
const QuickLinkSection = () => {
  return (
    <>
        <div className='quick-links-section sm:p-10 w-[100%] sm:h-[80%] sm:flex sm:justify-between'>
          
          <div className='company-logo sm:w-auto px-5 sm:py-0 py-3  text-center text-white'>
            <h3 className='c-name text-2xl font-bold'>XYZ Company Name...</h3>
          </div>
          <div className='product-quick-links w-auto px-5 sm:text-left text-center sm:py-0 py-3 text-white '>
          ...
          <div className='company-quick-links w-auto px-5 sm:text-left text-center sm:py-0 py-3 text-white'>
          ...
          <div className='stay-up-date sm:w-[40%] sm:text-left text-center sm:py-0 py-3 text-white '>
